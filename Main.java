...
class Main {
    ...
    // self testing cfg
    // Word testString = new Word("021");
    // Word testString = new Word("011"); //true
    // Word testString = new Word("11"); //false
    //System.out.println(p.isInLanguage(cfg, w));
    
    System.out.println("Testing");
    ArrayList<Derivation> t = parser.generateDerivations(cfg, testString.length());
    System.out.println("Go");
    System.out.println("len" + t.size());
    for(Derivation d: t){
      // System.out.println("Here");
      Word test = d.getLatestWord();
